...
warning icon, gray text, and a disabled *Active* checkbox; their
tooltip reads _File not found: <path>_ so you can spot stale
entries that the loader will never resolve.
...
The section header carries four small controls to the right of
...
`kbd:[Ctrl+&#43;]` / `kbd:[Ctrl+-]` adjust the editor text size too.
...
* *Add Watch.* The editor context menu's *Add Watch* uses the
  ...
  pause. With the script editor focused, `kbd:[Ctrl+Shift+B]`,
  `kbd:[Ctrl+F10]` (paused), and `kbd:[Ctrl+Shift+W]` match those
